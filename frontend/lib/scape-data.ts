  ...
  layers: [
    {
      ...
      label: "Chilled",
      history: [
        32, 38, 30, 39, 34, 41, 35, 44, 37, 46, 39, 49, 57, 47, 40, 45, 38, 43, 36, 42, 35, 40,
        33, 39, 32, 38,
      ],
      future: [34, 40, 33, 38, 32, 37, 31, 36, 30],
    },
    {
      id: "ambient",
      label: "Ambient",
      history: [
        66, 70, 64, 72, 68, 74, 69, 78, 73, 80, 76, 84, 92, 86, 79, 83, 76, 81, 74, 79, 72, 77,
        70, 75, 69, 74,
      ],
      future: [71, 76, 69, 74, 68, 73, 67, 72, 66],
    },
  ],
  /*
