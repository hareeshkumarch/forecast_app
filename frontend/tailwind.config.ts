  ...
  theme: {
    extend: {
      colors: {
        ...
        "land-band": "var(--land-band)",
        "land-band-rule": "var(--land-band-rule)",
        "land-brief": "var(--land-brief-bg)",
        "land-brief-border": "var(--land-brief-border)",
        "land-brief-rule": "var(--land-brief-rule)",
