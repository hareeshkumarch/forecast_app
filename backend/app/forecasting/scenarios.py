...
def build_intervals(
    ...
    *,
    ...
    lower = point_forecast - z_interval * sigmas
    upper = point_forecast + z_interval * sigmas
    worst = point_forecast - z_scenario * sigmas
    best = point_forecast + z_scenario * sigmas
